...
public class ProfilingTests : IDisposable
{
    ...
    public ProfilingTests(SharedTestDirectory testDirectory, ITestOutputHelper testHelper)
    {
    ...
    public async Task messages_totaling()
    {
        ...
        stopwatch.Stop();
        _testHelper.WriteLine($"Total time is {stopwatch.Elapsed.TotalMilliseconds}");
    }
