    ...
    public class GlobalActions : AbstractActions
    {
        ...
        public void MarkAsReadyToSend(Guid transactionId)
        {
            ...
            do
            {
                ...
                _logger.Debug("Marking output message {0} as Ready", new Guid(Api.RetrieveColumn(session, outgoing, ColumnsInformation.OutgoingColumns["msg_id"])));
        ...
        public void DeleteMessageToSend(Guid transactionId)
        {
        	...
        	do
            {
                _logger.Debug("Deleting output message {0}", new Guid(Api.RetrieveColumn(session, outgoing, ColumnsInformation.OutgoingColumns["msg_id"])));
