...
if [ "$(uname)" == "Darwin" ]; then
    dotnet test ./src/LightningQueues.Tests -f netcoreapp3.1
    ...
    make
    cd ../../../
    LD_LIBRARY_PATH=./lmdb/libraries/liblmdb/:$LD_LIBRARY_PATH dotnet test ./src/LightningQueues.Tests -f netcoreapp3.1
fi
